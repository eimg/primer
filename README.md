...
Primer does not publish workflow notifications to Steering in the current slice. Steering's advisors have no direct Primer access, and any future evidence integration must preserve Primer's actor, group, ACL, provenance, and citation boundaries before material enters a case or model context.
